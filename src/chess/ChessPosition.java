...
public class ChessPosition {
    ...
    public ChessPosition(char collumn, int row) {
        if (collumn < 'a' || collumn>'h' || row<1 || row>8){
            throw new ChessException ( "Error on instatiating Chessposition: valuer are from a1 to h8 " );
        }
    ...
    // linha de xadrez =  8 - linha do tabuleiro
    // coluna do board = codigo unicode da coluna xadrez - codigo unicode de 'a'
